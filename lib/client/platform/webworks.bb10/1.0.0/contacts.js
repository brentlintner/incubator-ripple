...
var Contact = ripple('platform/cordova/1.0.0/Contact'),
    ...
    CONTACTS_DB = "webworks-bb10-contacts",
    self;
...
function _getContacts() {
    var contactsDB = db.retrieveObject(CONTACTS_DB);

    return (contactsDB && contactsDB.map(function (person) {
...
self = module.exports = {
    ...
    find: function (fields, options, success, error) {
        var foundContacts = [],
