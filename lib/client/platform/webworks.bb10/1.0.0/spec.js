        ...
        blackberry: {
            children: {
                ...
                pim: {
                    children: {
                        contacts: {
                            path: "webworks.bb10/1.0.0/contacts",
                            feature: "blackberry.pim.contacts",
                            children: {
                                ContactError: {
                                    path: "webworks.bb10/1.0.0/ContactError"
                                },
                                Contact: {
                                    path: "webworks.bb10/1.0.0/Contact"
                                },
                                ContactName: {
                                    path: "webworks.bb10/1.0.0/ContactName"
                                },
                                ContactAddress: {
                                    path: "webworks.bb10/1.0.0/ContactAddress"
                                },
                                ContactOrganization: {
                                    path: "webworks.bb10/1.0.0/ContactOrganization"
                                },
                                ContactFindOptions: {
                                    path: "webworks.bb10/1.0.0/ContactFindOptions"
                                },
                                ContactField: {
                                    path: "webworks.bb10/1.0.0/ContactField"
                                },
                                ContactNews: {
                                    path: "webworks.bb10/1.0.0/ContactNews"
                                },
                                ContactPhoto: {
                                    path: "webworks.bb10/1.0.0/ContactPhoto"
                                },
                                ContactPickerOptions: {
                                    path: "webworks.bb10/1.0.0/ContactPickerOptions"
                                },
                                ContactActivity: {
                                    path: "webworks.bb10/1.0.0/ContactActivity"
                                }
                            }
                        }
                    }
